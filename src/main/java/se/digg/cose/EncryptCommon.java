    ...
    protected void ProcessCounterSignatures() throws CoseException {
        if (!counterSignList.isEmpty()) {
            if (counterSignList.size() == 1) {
                ...
                addAttribute(HeaderKeys.CounterSignature, counterSignList.get(0).EncodeToCBORObject(), UNPROTECTED);
            } else {
        ...
        if (counterSign1 != null) {
            ...
            addAttribute(HeaderKeys.CounterSignature0, counterSign1.EncodeToCBORObject(), UNPROTECTED);
        }
    }
