...
public class Encrypt0COSEObjectTest extends TestBase {
    ...
    public void testRoundTrip() throws Exception {
        ...
        msg = (Encrypt0COSEObject) COSEObject.DecodeFromBytes(rgbMsg, COSEObjectTag.Encrypt0);
    ...
    public void encryptUnknownAlgorithm() throws CoseException {
        ...
        msg.addAttribute(HeaderKeys.Algorithm, CBORObject.FromString("Unknown"), Attribute.PROTECTED);
        msg.SetContent(rgbContent);
        msg.encrypt(rgbKey128);
    }
    ...
    public void encryptBadIV() throws CoseException {
        ...
        msg.addAttribute(HeaderKeys.Algorithm, AlgorithmID.AES_GCM_128.AsCBOR(), Attribute.PROTECTED);
        msg.addAttribute(HeaderKeys.IV, CBORObject.FromString("IV"), Attribute.UNPROTECTED);
        msg.SetContent(rgbContent);
        msg.encrypt(rgbKey128);
    }
    ...
    public void encryptNoEmitContent() throws CoseException {
        ...
        msg.addAttribute(HeaderKeys.Algorithm, AlgorithmID.AES_GCM_128.AsCBOR(), Attribute.PROTECTED);
        msg.addAttribute(HeaderKeys.IV, CBORObject.FromByteArray(rgbIV96), Attribute.UNPROTECTED);
        msg.SetContent(rgbContent);
        msg.encrypt(rgbKey128);
        CBORObject cn = msg.EncodeCBORObject();
