...
public class SignWikiTest extends TestBase {
    ...
    public static byte[] MultiSignMessage(String ContentToSign, COSEKey[] keys) throws CoseException {
        // Create the signed message
        SignCOSEObject msg = new SignCOSEObject();
                ...
                if (!fSignerValidates) {
                    for (COSEKey k : keysWithoutKid) {
                        ...
                        try {
                            ...
                            System.out.println("This should most likely be handled or logged");
                        }
                        s.clearKey();
                    }
                }
