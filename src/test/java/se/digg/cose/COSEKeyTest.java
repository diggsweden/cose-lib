...
public class COSEKeyTest extends TestBase {
    ...
    public void testRoundTrip() throws CoseException {
        ...
        cborKey.Add(
            ...
            hexStringToByteArray("6c1382765aec5358f117733d281c1c7bdc39884d04a45a1e6c67c858bc206c19")
        );
        cborKey.Add(
            KeyKeys.EC2_Y.AsCBOR(),
            hexStringToByteArray("60f7f1a780d8a783bfb7a2dd6b2796e8128dbbcef9d3d168db9529971a36e7b9")
        );
        cborKey.Add(
            KeyKeys.EC2_X.AsCBOR(),
            hexStringToByteArray("143329cce7868e416927599cf65a34f3ce2ffda55a7eca69ed8919a394d42f0f")
        );
